import { getCanolaSeedData } from "@/lib/queries";
...
export default async function CanolaSeedPage() {
  const meta = getCommodityBySlug("canola-seed")!;
  const data = await getCanolaSeedData();
